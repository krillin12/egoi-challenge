                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('logs.update', $log) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="user_email" id="user_email" value="{{ $log->user_email }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $log->description }}</textarea>
                        </div>

                        <div class="mb-4">
                            <label for="at_time" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Time</label>
                            <input type="datetime-local" name="at_time" id="at_time" value="{{ $log->at_time }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
